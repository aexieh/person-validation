...
namespace Validation.Rules
{
    public class DriverLicenseNumberMaskRule : IRule
    {
        ...
        public bool Passed()
        {
            ...
            ViolationMessage = string.Format("Номер водительского удостоверения {0} должен состоять из 6 цифр", _checkingValue);
            return false;
        }
    }
}
